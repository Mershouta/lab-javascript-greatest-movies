...
function getAllDirectors(moviesArray, director) {
...
function orderByYear(moviesArray) {
    ...
    newArray.sort((first, seconde) => {
      if (first.year > seconde.year) {
        return 1;
      } else if ( first.year < seconde.year) {
        return -1;
      } else {
        if (first.title > seconde.title) {
          return 1;
        } else if ( first.title < seconde.title) {
          return -1;
        }
